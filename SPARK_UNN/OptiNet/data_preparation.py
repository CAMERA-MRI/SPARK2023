...
# Folder paths to use:
# /scratch/guest187/Data/train_all
# /scratch/guest187/Data/train_gli
# /scratch/guest187/Data/train_ssa

# /scratch/guest187/Data/val_SSA
if __name__ == "__main__":

    # prepare_dataset('/scratch/guest187/Data/train_ssa/ssa_all', True) # Training
    # print("Finished prepping all data!")
    # prepare_dataset('/scratch/guest187/Data/train_ssa/ssa_split48', True) # Training
    # print("Finished prepping spli48!")
    # prepare_dataset('/scratch/guest187/Data/train_ssa/ssa_split12', True) # Training
    # print("Finished prepping split12!")
    # prepare_dataset('/scratch/guest187/Data/val_ssa', False) # validation
    # print("Finished prepping val data!")
    prepare_dataset('/scratch/guest187/Data/train_gli', True) # Training
    print("Finished prepping all gli data!")
    prepare_dataset('/scratch/guest187/Data/val_gli', False) # validation
    print("Finished prepping val gli data!")