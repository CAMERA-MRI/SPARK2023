...
class Preprocessor:
    def __init__(self, args):
        ...
        self.training = args["prep_exec_mode"] == "training"
        self.data_path = os.path.join(args["prep_data"])
        ...
        if self.args["prep_exec_mode"] == "val":
    ...
    def run(self):
        ...
        self.run_parallel(self.preprocess_pair, self.args["prep_exec_mode"])
    ...
    def run_parallel(self, func, prep_exec_mode):
        return Parallel(n_jobs=self.args["n_jobs"])(delayed(func)(pair) for pair in self.metadata[prep_exec_mode])
