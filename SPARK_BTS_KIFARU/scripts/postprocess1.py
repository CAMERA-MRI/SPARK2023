...
# /scratch/guest189/BraTS2023_data/BraTS_Africa_data/BraTS2023_africa_val
    img = nib.load(
        f"/scratch/guest189/BraTS_Africa_data/BraTS2023_val/images/{fname}.nii.gz")
    nib.save(
        nib.Nifti1Image(p, img.affine, header=img.header),
        os.path.join(
            "/scratch/guest189/hackathon_data/results/final_preds1", fname + ".nii.gz"),
    )


os.makedirs("/scratch/guest189/hackathon_data/results/final_preds1")
# /scratch/guest189/BraTS2023_data/BraTS_Africa_data/BraTS2023_africa_val
preds = sorted(
    glob(f"/scratch/guest189/BraTS_Africa_data/val_results/predictions*"))
