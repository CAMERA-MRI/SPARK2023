...
class FlowSampler(Dataset):
    def __init__(self, dataroot, img_dir='/scratch/guest189/BraTS2023_data/BraTS_Africa_data/self_supervised/datasets/BraTS-GLI-files', base_img_paths=['BraTS-GLI']):
        ...
        base_label = load_numpy(os.path.join(img_dir, base_img_paths[0] + '-seg.npy.gz'))
