...
from configs import ct_max, ct_mean, ct_min, ct_std, patch_size, spacings, task
...
# if os.path.exists(untils_path) == False:
#     imgprocess_path = 'C:\\Users\\yzou10\\OneDrive - McGill University\\Patient-Specific_NucleiSize_Outcome\\CODE\\Image Processing'
#     sys.path.append(imgprocess_path)
...
class Preprocessor:
    def __init__(self, args):
        ...
        # self.data_path = os.path.join('/scratch/guest189/BraTS2023_data/BraTS_Africa_data', task[args.task]) 
        self.data_path = '/scratch/guest189/BraTS2023_data/BraTS_Africa_data/BraTS2023_africa_val'
        ...
        # self.results = os.path.join(args.results, "output_folder")
        self.results = '/scratch/guest189/BraTS2023_data/BraTS_Africa_data/BraTS2023_africa_train/12_3d'
    ...
    def preprocess_pair(self, pair):
        ...
        if self.args.dim == 3:
            ...
            #256,256,256 spacing = 1,1,1 nspaceing 3,3,3 85,85,85
        if self.modality == "CT":
