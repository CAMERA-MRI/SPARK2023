...
class NNUnet(pl.LightningModule):
    ...
    def on_validation_epoch_start(self):
        ...
        # Initialize an empty list to store validation outputs
    ...
    def on_validation_epoch_end(self):    #outputs
        ...
        # Process the accumulated validation outputs
        for results in self.val_output_list:
            # Perform any necessary post-processing or calculations using the results
            # Example: Accumulate the results in a list
        ...
        # Clear the val_output_list for the next validation epoch
        self.val_output_list = []
    ...
    def configure_optimizers(self):
        if self.args.optimizer.lower() == "sgd":
            optimizer = optim.SGD(self.parameters(), lr=self.learning_rate, momentum=self.args.momentum)
        elif self.args.optimizer.lower() == "adam":
            optimizer = optim.Adam(self.parameters(), lr=self.learning_rate, weight_decay=self.args.weight_decay)
        else:
