...
def get_main_args(strings=None):
    ...
    arg("--data", type=str, default="/scratch/guest189/hackathon_data", help="Path to data directory")
    # arg("--results", type=str, default="/results", help="Path to results directory")
    arg("--results", type=str, default="/scratch/guest189/hackathon_data/results", help="Path to results directory")
    ...
    arg("--ckpt_store_dir", type=str, default="/scratch/guest189/hackathon_data/results", help="Path for saving checkpoint")
