...
parser.add_argument("--data", type=str, default="/scratch/guest189/BraTS2023_data/BraTS_2021_data", help="Path to data directory")
parser.add_argument("--results", type=str, default="/scratch/guest189/BraTS2023_data/BraTS_2021_data", help="Path for saving results directory")
parser.add_argument(
    "--exec_mode",
    type=str,
    default="training",
