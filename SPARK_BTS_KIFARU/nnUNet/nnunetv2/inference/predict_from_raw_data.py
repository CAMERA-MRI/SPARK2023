...
class nnUNetPredictor(object):
    ...
    def _manage_input_and_output_lists(self, list_of_lists_or_source_folder: Union[str, List[List[str]]],
        ...
        print(list_of_lists_or_source_folder[:2])
        print(f'There are {len(list_of_lists_or_source_folder)} cases in the source folder')
        list_of_lists_or_source_folder = list_of_lists_or_source_folder[part_id::num_parts]
        print("Printing list_of_lists_or_source_folder:", list_of_lists_or_source_folder)
...
if __name__ == '__main__':
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset500_BraTS2023/imagesTr/BraTS-GLI-01281-000.nii.gz')])
