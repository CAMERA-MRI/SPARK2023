# Saving flair_x  #approved
print("flair_x no_image")
...
os.makedirs(base + "BraTS_data_africa/flair/x", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/flair/x/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/flair/x/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[s,:,:]
    path = base + "BraTS_data_africa/flair/x/embeddings/" +i+ "_"+ str(s)+".npy"
    if os.path.exists(path): continue
    # np.save(base + "BraTS_data_africa/flair/x/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/flair/x/embeddings/" +i+ "_"+ str(s), embedding)
