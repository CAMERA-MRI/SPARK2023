...
os.makedirs(base + "BraTS_data_africa/t2/z", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t2/z/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t2/z/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[:,:,s]
    # np.save(base + "BraTS_data_africa/t2/z/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t2/z/embeddings/" +i+ "_"+ str(s), embedding)
