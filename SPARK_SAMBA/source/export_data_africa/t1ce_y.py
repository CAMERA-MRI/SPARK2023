...
os.makedirs(base + "BraTS_data_africa/t1ce/y", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1ce/y/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1ce/y/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[:,s,:]
    # np.save(base + "BraTS_data_africa/t1ce/y/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t1ce/y/embeddings/" +i+ "_"+ str(s), embedding)
