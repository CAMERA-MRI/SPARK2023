...
os.makedirs(base + "BraTS_data_africa/t1ce/x", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1ce/x/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1ce/x/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[s,:,:]
    # np.save(base + "BraTS_data_africa/t1ce/x/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t1ce/x/embeddings/" +i+ "_"+ str(s), embedding)
