...
os.makedirs(base + "BraTS_data_africa/t2/y", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t2/y/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t2/y/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[:,s,:]
    # np.save(base + "BraTS_data_africa/t2/y/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t2/y/embeddings/" +i+ "_"+ str(s), embedding)
