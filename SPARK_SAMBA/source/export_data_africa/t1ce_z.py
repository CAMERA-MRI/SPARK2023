...
os.makedirs(base + "BraTS_data_africa/t1ce/z", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1ce/z/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1ce/z/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[:,:,s]
    # np.save(base + "BraTS_data_africa/t1ce/z/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t1ce/z/embeddings/" +i+ "_"+ str(s), embedding)
