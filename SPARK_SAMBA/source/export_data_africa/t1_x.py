...
os.makedirs(base + "BraTS_data_africa/t1/x", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1/x/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1/x/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    path = base + "BraTS_data_africa/t1/x/embeddings/" +i+ "_"+ str(s)+".npy"
    if os.path.exists(path): continue

    image = img[s,:,:]
    # np.save(base + "BraTS_data_africa/t1/x/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t1/x/embeddings/" +i+ "_"+ str(s), embedding)
