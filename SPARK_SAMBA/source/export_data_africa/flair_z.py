...
os.makedirs(base + "BraTS_data_africa/flair/z", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/flair/z/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/flair/z/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    path = base + "BraTS_data_africa/flair/z/embeddings/" +i+ "_"+ str(s)+".npy"
    if os.path.exists(path): continue

    image = img[:,:,s]
    # np.save(base + "BraTS_data_africa/flair/z/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/flair/z/embeddings/" +i+ "_"+ str(s), embedding)
