...
os.makedirs(base + "BraTS_data_africa/t1/y", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1/y/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/t1/y/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    path = base + "BraTS_data_africa/t1/y/embeddings/" +i+ "_"+ str(s)+".npy"
    if os.path.exists(path): continue

    image = img[:,s,:]
    # np.save(base + "BraTS_data_africa/t1/y/images/"+i+"_"+ str(s), image)
    ...
    np.save(base + "BraTS_data_africa/t1/y/embeddings/" +i+ "_"+ str(s), embedding)
