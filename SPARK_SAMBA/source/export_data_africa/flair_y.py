...
os.makedirs(base + "BraTS_data_africa/flair/y", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/flair/y/images", exist_ok=True)
os.makedirs(base + "BraTS_data_africa/flair/y/embeddings", exist_ok=True)
...
for i in tqdm(files):
  ...
  for s in range(num_slices):
    image = img[:,s,:]
    path = base + "BraTS_data_africa/flair/y/embeddings/" +i+ "_"+ str(s)+".npy"
    ...
    np.save(base + "BraTS_data_africa/flair/y/embeddings/" +i+ "_"+ str(s), embedding)
