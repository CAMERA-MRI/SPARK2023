...
parser.add_argument("--data", type=str, default="/scratch/guest188/BraTS_Africa_data", help="Path to data directory")
parser.add_argument("--results", type=str, default="/scratch/guest188/BraTS_Africa_data/results", help="Path for saving results directory")
parser.add_argument(
    "--exec_mode",
    type=str,
    default="training",
