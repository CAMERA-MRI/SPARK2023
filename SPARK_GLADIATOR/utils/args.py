...
def get_main_args(strings=None):
    ...
    arg("--data", type=str, default="/scratch/guest188/BraTS_Africa_data", help="Path to data directory")
    arg("--results", type=str, default="/scratch/guest188/BraTS_Africa_data/train_results_SS_only", help="Path to results directory")
    ...
    arg("--ckpt_path", type=str, default= "/scratch/guest188/BraTS_Africa_data", help="Path for loading checkpoint")
    arg("--ckpt_store_dir", type=str, default="/scratch/guest188/BraTS_Africa_data", help="Path for saving checkpoint")
