...
from novogradOptim.optimizer import Novograd as novograd
...
class NNUnet(pl.LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = {
            ...
            "novograd": novograd(self.parameters(), lr=self.learning_rate,betas=(0.9, 0.999),eps=1e-8,weight_decay=self.args.weight_decay, grad_averaging=False,amsgrad=False),
